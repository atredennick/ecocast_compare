...
factor and the variance of that factor.
...
\new{Using different distributions for the data and process models also helps make variance parameters identifiable when replicate observations are not available}
(Hobbs and Hooten 2015),
\new{thus avoiding a potential pitfall of state-space models}
...
The next step in testing \textbf{H1} is to compare Fig. 1B to results
from fast-growing populations.
...
participant; \(^1\)Technical liaison to Powell Center computing staf;
...
Another benefit of this project will be the conceptual advance of
