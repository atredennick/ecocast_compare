...
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Erin M. Schliep             | University of Missourt\     | Bayesian analysis,\             |   n/a                  |
...
\item[January 2018] First meeting for four days at Powell Center: Identify other appropriate data sets. Decide on model structures for each data set and identify climate data availability. Form two-person analysis teams for each data set. Go through YNP bison analysis as an exemplar. Define manuscripts.
...
\item[January 2019] Second meeting for four days at Powell Center: Analysis teams present results for feedback from the working group. Finalize data base and identify any outstanding issues. Evaluate manuscript drafts and form writing teams. Create a \textsc{GitHub} repository for individual forecasts.
