...
\begin{description}
\item[Date:] \today
\item[Descriptive Title:] Synthesizing time series of plant and animal populations to understand the current limits to ecological forecasts
...
Testing our hypotheses requires applying a standardized analytical approach to a synthetic data set representative of many species – an activity that \emph{\textbf{can only be done at the Powell Center}} as a working group. 
