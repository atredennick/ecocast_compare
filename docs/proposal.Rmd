...
+=============================+=============================+=================================+========================+
| Andrew Tredennick*$^\dagger$| Utah State University\      | Data management/synthesis,\     |  n/a                   |
...
|                             |                             | data synthesis                  |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Brittany Teller             |  Utah State University\     | data management, statistics,\   |   Idaho sagebrush      |
|                             | \phantom{}                  | detecting climate drivers       |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
