...
| Animal | Several (Breeding Bird Survey)* | 47 |  http://www.pwrc.usgs.gov/bbs/ |
...
| Plant | *Artemisia scopulorum* (Alpine Sagewort)* | 11 | http://niwot.colorado.edu/ |
...
\vspace{-2em}
*These datasets contain observations for many species, not just the one listed as an example.
...
Of the 10 listed participants, four are women and three are early career scientists.
...
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Mevin Hooten*               | U.S. Geological Survey\     | Bayesian modeling,\             |   Sandhill crane       |
|                             |                             | statistical forecasting         |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Peter Adler*                | Utah State University\      | population ecology/modeling,\   |   Idaho sagebrush      |
|                             |                             | data synthesis                  |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Lauren Buckley              | University of Washington\   | ecological forecasting\         |   *Anolis* spp.        |
|                             |                             | climate change                  |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
