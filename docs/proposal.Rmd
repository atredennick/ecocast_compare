...
\item[H1.] \textbf{The contribution of initial conditions error to forecast uncertainty is greater for fast growing populations than for slow growing populations.} Fast growing populations are more likely to exhibit chaotic or near-chaotic dynamics, which inflates forecast error due to initial conditions uncertainty. We will compare forecast partitions for \emph{Bison bison} (slow growing population) and \emph{Dipodomys} spp. (fast growing populations) to test this hypothesis.
...
We have assembled a diverse working group, with gender and career stage diversity.
We will also advertise two travel awards for participation in our working group: one for a postdoc to participate and one for a graduate student to participate.
The travel awards will be advertised on ESA's SEEDS\footnote{http://esa.org/seeds/} and Inclusive Ecology\footnote{http://www.esa.org/inclusive-ecology/} webpages to ensure we receive applications from underrepresented minorities.
...
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Emily Farrer                | Tulan University\           | population modeling,\           |   Niwot plants         |
|                             | \phantom{}                  | Bayesian analysis               |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Ethan White                 | University of Florida\      | ecological forecasting,\        |   BBS \& Portal Data   |
|                             | \phantom{}                  | data synthesis                  |                        |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Graduate Student            | \phantom{}\                 | \phantom{}\                     |   n/a                  |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
| Postdoctoral Scholar        | \phantom{}                  | \phantom{}                      |   n/a                  |
+-----------------------------+-----------------------------+---------------------------------+------------------------+
...
\item[July to September 2019] Complete manuscripts and submit for publication. Release database and forecast repository to Powell Center for permanent archiving. Write a blog post for Dynamic Ecology\footnote{http://dynamicecology.wordpress.com/} on the limits to ecological forecasting, introduce to database and forecast repositry, and pose a forecasting challenge.
