...
Our analysis suggests that the forecast is limited by the process model.
We could improve the process model by including external climate covariates, which we plan to do as part of this proposal.
Doing so will also allow us to determine the relative contribution of driver error to forecast uncertainty through time.
