...
YOU COULD CUT THIS LAST SENTENCE TO SAVE SPACE.
...
We will work with study area experts (Table 2) to decide on appropriate climate covariates for each time series and with Powell Center experts to synthesize our data sets (WHAT DOES THIS MEAN?).
